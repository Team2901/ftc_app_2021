...
import org.firstinspires.ftc.teamcode.Shared.Hardware.ProgrammerMechanumHardware;

@Disabled
@TeleOp(name = "ProgrammerMechanum", group = "Shared")
public class ProgrammerMechanumTeleOp extends OpMode {
    ProgrammerMechanumHardware robot = new ProgrammerMechanumHardware();
